    ...
    Card(
        ...
        Column(
            ...
            if (bankItem.bankBranch.isNullOrEmpty()) {
                BankDataCardItem(Icons.Default.AccountBalance, "${bankItem.bankDistrict} Şubesi / ${bankItem.bankCity}")
            } else {
                BankDataCardItem(Icons.Default.AccountBalance, "${bankItem.bankBranch} / ${bankItem.bankDistrict} Şubesi / ${bankItem.bankCity}")
            }
